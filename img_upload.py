...
file_name = "BC.pdf"
pdf_file_size = 3497330

pdf_api = video_download_url(file_name, pdf_file_size)
print(pdf_api)
download_url = pdf_api.get("download_url")
upload_url = pdf_api.get("upload_url")
fields = pdf_api.get("fields")

video_file_name = "BC.pdf"
...
#             # file_name = row["lesson_title"].replace("|", "_").replace("-", "_")
...
#             video_file_name = f"{lesson_id}.pdf"
#             upload_s3 = upload_to_s3(upload_url, video_file_name, fields)
...
#             print(f"Successfully uploaded for -> {lesson_id}")
